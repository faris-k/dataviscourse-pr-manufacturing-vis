...
const colorScheme = () => ({
  'normal': ['#FFAAD3', '#FF9D7A', '#FFDE69', '#A4E8A3', '#8AE6FB', '#E2D4FF', '#FFF5D2'],
  'bright': ['#760039', '#5B0505', '#594600', '#004012', '#00303A', '#400356', '#594600'],
});
...
const initStaticDataViewer = (container) => {
  loadData().then((data) => {
    ...
    let treeContainer = mainContainer.append('div')
      .attr('class', 'row')
      .append('div')
      .attr('class', 'col-xxl-12')
      .attr('id', 'tree-container');

    let tableContainer = mainContainer.append('div')
      .classed('row', true)
      .append('div')
      .attr('class', 'col-xxl-12')
